  ...
  >
    ...
    >
      <template scope="scope">
        <span v-for="(space, levelIndex) of scope.row._level" v-if="spaceIconShow(index)" :key="levelIndex" class="ms-tree-space" />
    ...
    <el-table-column v-if="treeType === 'normal'" align="center" label="操作">
